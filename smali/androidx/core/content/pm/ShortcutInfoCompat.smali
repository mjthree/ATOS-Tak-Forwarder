...
.method static fromShortcuts(Landroid/content/Context;Ljava/util/List;)Ljava/util/List;
    ...
    .line 24
    invoke-static {v1}, Latak/core/Wh;->a(Ljava/lang/Object;)Landroid/content/pm/ShortcutInfo;
...
.method static getLocusId(Landroid/content/pm/ShortcutInfo;)Landroidx/core/content/LocusIdCompat;
    ...
    .line 3
    invoke-static {p0}, Latak/core/Xh;->a(Landroid/content/pm/ShortcutInfo;)Landroid/content/LocusId;
    ...
    .line 5
    :cond_1
    invoke-static {p0}, Latak/core/Yh;->a(Landroid/content/pm/ShortcutInfo;)Landroid/os/PersistableBundle;
...
.method public toShortcutInfo()Landroid/content/pm/ShortcutInfo;
    ...
    .line 1
    invoke-static {}, Latak/core/si;->a()V
    ...
    .line 7
    .line 8
    invoke-static {v0, v1}, Latak/core/Zh;->a(Landroid/content/Context;Ljava/lang/String;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    .line 13
    .line 14
    invoke-static {v0, v1}, Latak/core/Sh;->a(Landroid/content/pm/ShortcutInfo$Builder;Ljava/lang/CharSequence;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    .line 19
    .line 20
    invoke-static {v0, v1}, Latak/core/Gi;->a(Landroid/content/pm/ShortcutInfo$Builder;[Landroid/content/Intent;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    .line 34
    invoke-static {v0, v1}, Latak/core/Hi;->a(Landroid/content/pm/ShortcutInfo$Builder;Landroid/graphics/drawable/Icon;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    .line 46
    .line 47
    invoke-static {v0, v1}, Latak/core/Ii;->a(Landroid/content/pm/ShortcutInfo$Builder;Ljava/lang/CharSequence;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    .line 59
    .line 60
    invoke-static {v0, v1}, Latak/core/Ji;->a(Landroid/content/pm/ShortcutInfo$Builder;Ljava/lang/CharSequence;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    .line 66
    .line 67
    invoke-static {v0, v1}, Latak/core/Ki;->a(Landroid/content/pm/ShortcutInfo$Builder;Landroid/content/ComponentName;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    .line 73
    .line 74
    invoke-static {v0, v1}, Latak/core/Th;->a(Landroid/content/pm/ShortcutInfo$Builder;Ljava/util/Set;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    .line 78
    .line 79
    invoke-static {v0, v1}, Latak/core/Uh;->a(Landroid/content/pm/ShortcutInfo$Builder;I)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    .line 85
    .line 86
    invoke-static {v0, v1}, Latak/core/Ei;->a(Landroid/content/pm/ShortcutInfo$Builder;Landroid/os/PersistableBundle;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    .line 121
    :cond_6
    invoke-static {v0, v2}, Latak/core/Vh;->a(Landroid/content/pm/ShortcutInfo$Builder;[Landroid/app/Person;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    .line 132
    invoke-static {v0, v1}, Latak/core/Ci;->a(Landroid/content/pm/ShortcutInfo$Builder;Landroid/content/LocusId;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    .line 136
    .line 137
    invoke-static {v0, v1}, Latak/core/Di;->a(Landroid/content/pm/ShortcutInfo$Builder;Z)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    .line 159
    :cond_a
    invoke-static {v0}, Latak/core/Fi;->a(Landroid/content/pm/ShortcutInfo$Builder;)Landroid/content/pm/ShortcutInfo;
